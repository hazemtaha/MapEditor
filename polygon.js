...
app.isInsidePoly = function(point, polygon) {
        var x = point.x,
            y = point.y,
            inside = false;
    ...
    for (var i = 0; i < blocks.length; i++) {
        ...
        switch (blocks[i].type) {
            case 'polygon':
                ...
                if (app.isInsidePoly(point, shape)) {
                    console.log(blocks[i]);
                    return blocks[i];
                }
                break;
            case 'rect':
                if (app.isInsideRect(point, shape)) {
                    console.log(blocks[i]);
                ...
                break;
            case 'circle':
                if (app.isInsideCircle(point, shape)) {
                    console.log(blocks[i]);
                ...
                break;
            case 'oval':
                if (app.isInsideOval(point, shape)) {
                    console.log(blocks[i]);
